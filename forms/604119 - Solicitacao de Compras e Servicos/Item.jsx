    ...
    render() {
        return (
            <div className="with-suffix" suffix={this.props.CodUndItem}>
                <input type="text" className={"form-control " + this.props.className} name={this.props.name} value={this.formatValue(this.props.value)} onChange={(e) => this.handleChange(e)} readOnly={this.props.readOnly} />
            </div>
        );
    }
}
                    ...
                    <div className="panel-body">
                        ...
                        <div className="tab-content">
                            <div className="tab-pane active tabInfoItem" id={"tabInfoItem_" + id}>
                                <div className="row">
                                    ...
                                    <div className="col-md-6 col-lg-4">
                                        <label className="labelFullWidth">
                                            Descrição:
                                            <input name="DescricaoItem" type={"text"} className="form-control DescricaoItem" value={this.props.item.DescricaoItem} onChange={(e) => this.props.onChangeInputItem("ChangeInput", this.props.countItem, "DescricaoItem", e.target.value)} />
                                        </label>
                                        <br />
                                    </div>
                                    <div className="col-md-12 col-lg-4">
                                        <div className="row">
                                            <div className="col-md-6">
                                                <label className="labelFullWidth">
                                                    Quantidade:
                                                    <InputPrefix name="QuantidadeItem" className="QuantidadeItem" value={this.props.item.QuantidadeItem} onChange={(e) => this.props.onChangeInputItem("ChangeInput", this.props.countItem, "QuantidadeItem", e.target.value)} CodUndItem={this.props.item.CodUndItem} />
                                                </label>
                                                <br />
                                            </div>
                                            <div className="col-md-6">
                                ...
                                <div className="row" style={{ display: $("#atividade").val() == 5 && $("#formMode").val() != "VIEW" ? "block" : "none" }}>
                                    <div className="col-md-12">
                                        <label className="labelFullWidth">
                                            ...
                                            <textarea value={this.props.item.PrazoEntrega} className="form-control PrazoEntrega" rows="3" onChange={(e) => this.props.onChangeInputItem("ChangeInput", this.props.countItem, "PrazoEntrega", e.target.value)} />
                                        </label>
                                    </div>
                                </div>
                                <br />
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <div style={{ marginLeft: "150px", display: this.props.item.SubEmpreiteiro ? "block" : "none" }} className="row divSubEmpreiteiro">
                                            <div className="col-md-6">
                                                ...
                                                <antd.Select style={{ width: "100%" }} showSearch value={this.props.item.SubEmpreiteiroSelect} filterOption={(input, option) => (option?.label ?? "").toLowerCase().includes(input.toLowerCase())} onChange={(e) => this.props.onChangeInputItem("ChangeInput", this.props.countItem, "SubEmpreiteiroSelect", e)} options={this.props.listFornecedores} />
                                            </div>
                                            <div className="col-md-6">
                                                <label className="labelFullWidth">Observação:</label>
                                                <input type="text" className="form-control inputObservacaoSubEmpreiteiro" name="SubEmpreiteiroObservacao" value={this.props.item.SubEmpreiteiroObservacao} onChange={(e) => this.props.onChangeInputItem("ChangeInput", this.props.countItem, "SubEmpreiteiroObservacao", e.target.value)} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="tab-pane tabInfoItem" id={"tabRateio_" + id}>
                                <RateiosItem RateioCCusto={this.props.item.RateioCCusto} RateioDepto={this.props.item.RateioDepto} ValorItem={this.props.item.ValorUnitItem * this.props.item.QuantidadeItem} listCCustos={this.props.listCCustos} listDepto={this.props.listDepto} onChangeRateio={(operacao, countLinhaDepto, attr, value) => this.props.onChangeRateioItem(operacao, this.props.countItem, countLinhaDepto, value, attr)} />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    componentDidMount() {
        ...
        dataTableNovoItem.on("draw", { onIncluirItem: this.handleIncluirItem }, (event) => {
            ...
            $(".btnSelecionaProduto").on("click", { onIncluirItem: event.data.onIncluirItem }, async function (event) {
                ...
                var valida = validaSeUsuarioTemPermissaoNoProduto(values.IDPRD, values.CODIGOPRD + " - " + values.NOMEFANTASIA);
        ...
        return (
            <div style={{ display: this.props.style == "hide" ? "none" : "block" }}>
                <div id="divRateioIncluirItem" className="panel panel-primary">
                    ...
                    <div className="panel-body">
                        <RateiosItem RateioCCusto={this.state.RateioCCusto} RateioDepto={this.state.RateioDepto} listFornecedores={this.props.listFornecedores} listCCustos={this.props.listCCustos} listDepto={this.props.listDepto} ValorItem={0.0} onChangeRateio={(o, c, v, a) => this.handleChangeRateio(o, c, v, a)} />
                    </div>
                </div>
                <div className="panel panel-primary">
                    <div className="panel-heading">
...
class RateiosItem extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        if (this.props.RateioCCusto != nextProps.RateioCCusto || this.props.RateioDepto != nextProps.RateioDepto || this.props.listDepto != nextProps.listDepto || this.props.listCCustos != nextProps.listCCustos || this.props.ValorItem != nextProps.ValorItem) {
            return true;
        }
        return false;
    }
        ...
        for (let i = 0; i < RateioDepto.length; i++) {
            ...
            retorno.push(
                <tr key={i}>
                    <td>{i + 1}</td>
                    <td>
                        <antd.Select style={{ width: "100%" }} className="selectDepartamento" showSearch value={rateio.Departamento} filterOption={(input, option) => (option?.label ?? "").toLowerCase().includes(input.toLowerCase())} onChange={(e) => this.props.onChangeRateio("ChangeRateioDepto", i, "Departamento", e)} options={this.props.listDepto} />
                    </td>
                    <td>
        ...
        return (
            <div className="rateioItem">
                <div className="row">
                    <div className="col-md-12">
                        <label className="labelFullWidth">
                            Rateio por Centro de Custo: <antd.Select style={{ width: "100%" }} name="RateioCCusto" className="RateioCCusto" showSearch value={this.props.RateioCCusto} filterOption={(input, option) => (option?.label ?? "").toLowerCase().includes(input.toLowerCase())} onChange={(e) => this.props.onChangeRateio("ChangeRateioCCusto", null, null, e)} options={this.props.listCCustos} />
                        </label>
                    </div>
                </div>
                <br />
...
class AppRoot extends React.Component {
    ...
    constructor(props) {
        ...
        if ($("#itens").val() != "") {
            ...
            /*if ($("#cotacoes").val() != "") {
                var cotacao = JSON.parse($("#cotacoes").val())[0];
    ...
    componentDidMount() {
        DatasetFactory.getDataset("FCFO", ["CODCFO", "NOME", "CGCCFO"], [DatasetFactory.createConstraint("CODCOLIGADA", 0, 0, ConstraintType.SHOULD), DatasetFactory.createConstraint("CODCOLIGADA", $("#coligada").val().split(" - ")[0], $("#coligada").val().split(" - ")[0], ConstraintType.SHOULD), DatasetFactory.createConstraint("ATIVO", 1, 1, ConstraintType.MUST)], null, {
            success: (ds) => {
                var options = [];
        ...
        DatasetFactory.getDataset("GCCUSTO", null, [DatasetFactory.createConstraint("ATIVO", "T", "T", ConstraintType.MUST), DatasetFactory.createConstraint("CODCOLIGADA", $("#coligada").val().split(" - ")[0], $("#coligada").val().split(" - ")[0], ConstraintType.MUST), DatasetFactory.createConstraint("CODCCUSTO", "1.2.043", "1.2.043", ConstraintType.MUST_NOT)], ["CODCCUSTO"], {
            success: (ds) => {
                var retorno = [];
    ...
    renderItens() {
        ...
        for (var i = 0; i < this.state.itens.length; i++) {
            ...
            html.push(<Item key={i} item={item} countItem={i} listCCustos={this.state.listCCustos} listDepto={this.props.listDepto} listFornecedores={this.state.listFornecedores} onChangeInputItem={(e, i, j, k) => this.handleChangeItem(e, i, j, k)} onChangeRateioItem={(operacao, item, countLinhaDepto, value, attr) => this.handleChangeRateioItem(operacao, item, countLinhaDepto, value, attr)} />);
        }
        return html;
    }
    ...
    render() {
        return (
            <ErrorBoundary>
                ...
                <TabelaProdutos onIncluirItem={(e) => this.handleChangeItem("IncluirItem", e)} listDepto={this.props.listDepto} listCCustos={this.state.listCCustos} listFornecedores={this.state.listFornecedores} style={this.state.abaShown == "itens" ? "hide" : ""} />
...
class OrcamentoRoot extends React.Component {
        ...
        this.state.orcamentos.forEach((orcamento, i) => {
            orcamentos.push(
                <Orcamento
                    ...
                    onChangeRateioItem={(operacao, item, countLinhaDepto, value, attr, orcamento) => this.handleChangeRateioItem(operacao, item, countLinhaDepto, value, attr, orcamento)}
                />
            );
        });
    ...
    componentDidMount() {
        DatasetFactory.getDataset("FCFO", ["CODCOLIGADA", "CODCFO", "NOME", "CGCCFO"], [DatasetFactory.createConstraint("CODCOLIGADA", 0, 0, ConstraintType.SHOULD), DatasetFactory.createConstraint("CODCOLIGADA", $("#coligada").val().split(" - ")[0], $("#coligada").val().split(" - ")[0], ConstraintType.SHOULD), DatasetFactory.createConstraint("ATIVO", 1, 1, ConstraintType.MUST)], null, {
            success: (ds) => {
                var options = [];
                ds.values.forEach((fornecedor) => {
                    options.push({
...
class Orcamento extends React.Component {
    ...
    renderItens() {
        ...
        for (var i = 0; i < this.props.orcamento.itens.length; i++) {
            ...
            html.push(<Item key={i} item={item} countItem={i} listCCustos={this.props.listCCustos} listDepto={this.props.listDepto} listFornecedores={this.props.listFornecedores} onChangeInputItem={(operacao, item, value, attr) => this.props.onChangeInputItem(operacao, item, value, attr, this.props.countOrcamento)} onChangeRateioItem={(operacao, item, countLinhaDepto, value, attr) => this.props.onChangeRateioItem(operacao, item, countLinhaDepto, value, attr, this.props.countOrcamento)} />);
        }
        return html;
    }
                        ...
                        <div style={{ display: "grid" }}>
                            <div className="row">
                                ...
                                <div className="col-md-1" style={{ textAlign: "right" }}>
                                    <div className="details"></div>
                                    <button className="btn btn-danger btnRemoverItem" onClick={() => this.props.onChangeOrcamento("RemoverOrcamento", null, null, this.props.countOrcamento)}>
                                        <i className="flaticon flaticon-trash icon-sm" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                ...
                <div className="panel-body">
                    <div className="row">
                        <div className="col-md-6">
                            <label className="labelFullWidth">
                                Fornecedor:
                                <antd.Select style={{ width: "100%" }} className="selectFornecedor" showSearch value={this.props.orcamento.fornecedor} filterOption={(input, option) => (option?.label ?? "").toLowerCase().includes(input.toLowerCase())} onChange={(e) => this.props.onChangeOrcamento("ChangeOrcamento", "fornecedor", e, this.props.countOrcamento)} options={this.props.listFornecedores} />
                            </label>
                        </div>
                        <div className="col-md-6">
                            <label className="labelFullWidth">
                                Condição de Pagamento:
                                <antd.Select style={{ width: "100%" }} className="selectCondicaoPagto" showSearch value={this.props.orcamento.condicaoPagamento} filterOption={(input, option) => (option?.label ?? "").toLowerCase().includes(input.toLowerCase())} onChange={(e) => this.props.onChangeOrcamento("ChangeOrcamento", "condicaoPagamento", e, this.props.countOrcamento)} options={this.props.listCondicaoPagamento} />
                            </label>
                        </div>
                    </div>
                    <br />
            ...
            <div className="resumoMovimento">
                <div className="panel panel-primary">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-5" style={{ textAlign: $("#isMobile").val() != "true" ? "right" : "left", verticalAlign: "middle" }}>
                                {VerificaSeLocalDeEstoqueTemREIDI($("#locEstoque").val().split(" - ")[1]) && (
                                    <span>
                                        <b>REIDI: </b>
                                        <span style={{ marginRight: "40px" }}>{$("#REIDI").val()}</span>
                                    </span>
                                )}
                    ...
                    <div className="panel-body">
                        ...
                        >
                            {this.props.movimento.itens.map((item, i) => (
...
class InformacoesIniciaisRoot extends React.Component {
    //Componente usado nas atividades Inicio e Orcamento para renderizar a aba Informações Iniciais
    //Cada campo do Componente contem um hiddenField no formulario, e sempre que o valor do campo é alterado no Componente o valor é salvo no hiddenField

    //Aqui também é inicializado o Componente AppRoot, quando a filial é selecionada

    constructor(props) {
        super(props);

        var date = $("#dataEntrega").val();
        this.state = {
            filial: $("#filial").val(),
        ...
        if (this.state.filial != "" && $("#formMode").val() != "VIEW") {
            this.buscaLocEstoque();
        }
    }

    buscaLocEstoque() {
        BuscaLocalDeEstoque(this.state.filial.split(" - ")[0]).then((list) => {
            this.setState({
                listLocEstoque: list
            });
        });
    ...
    componentDidMount() {
        ...
        calendar.setDate($("#dataEntrega").val());
    }

    CriaAppRoot() {
        DatasetFactory.getDataset("DepartamentosRM", null, [DatasetFactory.createConstraint("codcoligada", $("#coligada").val().split(" - ")[0], $("#coligada").val().split(" - ")[0], ConstraintType.MUST), DatasetFactory.createConstraint("codfilial", this.state.filial.split(" - ")[0], this.state.filial.split(" - ")[0], ConstraintType.MUST)], null, {
            success: (ds) => {
                var retorno = [];
                ds.values.forEach((departamento) => {
                    retorno.push({
        ...
        this.setState(
            ...
            () => {
                if (chave == "filial") {
                    ...
                    valor = dia + "/" + mes + "/" + ano;
                } else if (chave == "comprador" || chave == "locEstoque") {
                    BuscaComprador(this.state.comprador, this.state.locEstoque.split(" - ")[1]).catch(() => {
                        this.setState({
                            [chave]: ""
                        });
                    });

                    if (chave == "locEstoque" && !VerificaSeLocalDeEstoqueTemREIDI(valor.split(" - ")[1])) {
                        //Caso o Local de estoque tenha sido alterado, verifica se o local de estoque tem REIDI, se nao tiver muda a opcao REIDI pra Nao
                        this.setState({ REIDI: "Nao" });
                        $("#REIDI").val("Nao");
                    }
                }
                //Atualiza no Formulario o hiddenField com o mesmo ID do STATE
                $("#" + chave).val(valor);
            }
        );
    }
    ...
    optionsNatureza() {
        var retorno = buscaNatureza(this.state.filial.split(" - ")[0]);
        if (retorno.length == 0) {
            this.state.natureza = "";
            $("#natureza").val("");
        }
        var options = [<option></option>];
        for (const nat of retorno) {
            options.push(
        ...
        return (
            <ErrorBoundary>
                <div>
                    <div className="row">
                        <div className="col-md-3">
                            <div className="form-input">
                                <label className="labelFullWidth">
                                    Filial:
                                    <antd.Select style={{ width: "100%" }} showSearch value={this.state.filial} filterOption={(input, option) => (option?.label ?? "").toLowerCase().includes(input.toLowerCase())} onChange={(e) => this.handleChangeInput("filial", e)} options={this.props.listFiliais} />
                                </label>
                            </div>
                            <br />
                        </div>
                        <div className="col-md-3">
                            <div className="form-input">
                                <label className="labelFullWidth">
                                    Local de Estoque:
                                    <antd.Select style={{ width: "100%" }} showSearch value={this.state.locEstoque} filterOption={(input, option) => (option?.label ?? "").toLowerCase().includes(input.toLowerCase())} onChange={(e) => this.handleChangeInput("locEstoque", e)} options={this.state.listLocEstoque} />
                                </label>
                            </div>
                            <br />
                        </div>
                        <div className="col-md-3">
                            <div className="form-input">
                                <label className="labelFullWidth">
                                    Comprador:
                                    <select value={this.state.comprador} className="form-control" onChange={(e) => this.handleChangeInput("comprador", e.target.value)}>
                                        <option value=""></option>
                        ...
                        <div className="col-md-3">
                            <div className="form-input">
                                <label className="labelFullWidth">
                                    ...
                                    format={"DD/MM/YYYY"}
                                    onChange={(e) => this.handleChangeInput("dataEntrega", e)}
                    ...
                    <div className="row">
                        <div className="col-md-3">
                            <div className="form-input">
                                <label className="labelFullWidth">
                                    Condição de Pagamento:
                                    <antd.Select style={{ width: "100%" }} showSearch value={this.state.condicaoPgto} filterOption={(input, option) => (option?.label ?? "").toLowerCase().includes(input.toLowerCase())} onChange={(e) => this.handleChangeInput("condicaoPgto", e)} options={this.props.listCondicaoPagamento} />
                                </label>
                            </div>
                            <br />
                        </div>
                        <div className="col-md-3">
                            <div className="form-input">
                                <label className="labelFullWidth">
                                    Forma de Pagamento:
                                    <antd.Select style={{ width: "100%" }} showSearch value={this.state.formaPgto} filterOption={(input, option) => (option?.label ?? "").toLowerCase().includes(input.toLowerCase())} onChange={(e) => this.handleChangeInput("formaPgto", e)} options={this.props.listFormaPagamento} />
                                </label>
                            </div>
                        </div>
                        <div className="col-md-3">
                            <div className="form-input">
                                <label className="labelFullWidth">
                                    Transporte:
                                    <antd.Select style={{ width: "100%" }} showSearch value={this.state.codTransporte} filterOption={(input, option) => (option?.label ?? "").toLowerCase().includes(input.toLowerCase())} onChange={(e) => this.handleChangeInput("codTransporte", e)} options={this.props.listTransporte} />
                                </label>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-6">
                            <div className="form-input">
                                <label className="labelFullWidth">
                                    Local de entrega:
                                    <antd.Select style={{ width: "100%" }} showSearch value={this.state.locEntrega} filterOption={(input, option) => (option?.label ?? "").toLowerCase().includes(input.toLowerCase())} onChange={(e) => this.handleChangeInput("locEntrega", e)} options={this.props.listLocalEntrega} />
                                </label>
                            </div>
                            <br />
                        </div>
                        <div className="col-md-6">
                            <div className="form-input">
                                <label className="labelFullWidth">
                                    ...
                                    <input type={"text"} className="form-control" value={this.state.locEntrega2} onChange={(e) => this.handleChangeInput("locEntrega2", e.target.value)} />
                                </label>
                            </div>
                            <br />
                        </div>
                    ...
                    <div className="row">
                        <div className="col-md-6" style={{ display: VerificaSeLocalDeEstoqueTemREIDI(this.state.locEstoque.split(" - ")[1]) ? "block" : "none" }}>
                            <label className="labelFullWidth">
                                REIDI:
                                <select value={this.state.REIDI} className="form-control" onChange={(e) => this.handleChangeInput("REIDI", e.target.value)}>
                                    <option value=""></option>
                        ...
                        <div className="col-md-6" style={{ display: $("#coligada").val() == "2 - CASTILHO MINERACAO" ? "block" : "none" }}>
                            <label className="labelFullWidth">
                                Natureza Fiscal:
                                <select value={this.state.natureza} className="form-control" onChange={(e) => this.handleChangeInput("natureza", e.target.value)}>
